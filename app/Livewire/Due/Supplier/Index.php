...
namespace App\Livewire\Due\Supplier;
...
class Index extends Component
{
    ...
    public function storeSupplierDue()
    {
        ...
        $notification=array('msg' => 'Supplier Due Successfully Inserted!', 'alert-type' => 'success');
        return redirect()->route('supplier.due.create')->with($notification);
...
//    }
    ...
    public function render()
    {
        ...
        return view('livewire.due.supplier.index', get_defined_vars());
    }
}
