...
<div class="row">
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2>Daily Summary Report  <small>Show your Daily Summary Report from here</small></h2>
                <ul class="nav navbar-right panel_toolbox">
                    <li>
                        @if($date)<a href="{{route('daily.report.pdf',$date)}}" class="btn btn-info btn-link">Download <i class="fa fa-file-pdf-o text-danger"></i></a>@endif
                    </li>
