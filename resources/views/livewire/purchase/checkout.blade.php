                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <table  class="table table-striped table-bordered" cellspacing="0" width="100%" >
                                ...
                                <tbody>
                                    ...
                                    @php
                                       // $total_discount+=$product->options->discount;
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <h5 class="x_title text-center">Amount Calculation</h5>
                    <div class="px-3">
                        ...
                        <table class="table table-striped table-bordered">
                            <tr><th>Total Purchase<td>= {{Cart::instance('purchase')->total()-Cart::instance('purchase')->tax()}}/=</td></th></tr>
                            ...
                            <tr><th>Carring<td> <input type="text" wire:model.lazy="carring" name="carring" class="form-control"></td></th></tr>
                            <tr><th>Other Charge<td> <input type="text" wire:model.lazy="other_charge" name="other_charge" class="form-control"></td></th></tr>
                            <tr><th>Grand Total<td>= {{$grand_total . '/=' ?? ''}}</td></th></tr>
                            @if(isset($advance_pay))
                                <tr><th>Previous Due<td>= -{{$advance_pay  .'/=' ?? ''}}</td></th></tr>
                                <tr><th>Current Due<td>= {{$grand_total-$advance_pay  .'/=' ?? ''}}</td></th></tr>
                            @else
                            ...
                            <tr><th>Due Amount<td><input type="text"  name="current_due" readonly value="{{$current_due}}"  class="form-control"></td></th></tr>
                        </table>
                    </div>
            </div>
        </div>
