<div>
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Add Supplier Due <small>Add your Supplier Due from here</small></h2>
                ...
                <div class="x_content">
                    ...
                    @endif
                    <form wire:submit.prevent="storeSupplierDue()"  enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        @csrf
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    <div class="customer-search-area ">
                                        <div class="form-group" wire:ignore>
                                            <select type="search"  name="supplier_search" id="due-supplier-search"   placeholder="search" class="form-control">
                                                <option value=""></option>
    ...
    <script>
        $(document).ready(function () {
           $('#due-supplier-search').select2();
           $('#due-supplier-search').on('change', function (e) {
