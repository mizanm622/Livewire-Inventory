<div class="x_panel">
    <div class="x_title">
        <h2>Return Checkout Page<small>Submit your Sales return order from here</small></h2>
                            ...
                            <table  class="table table-striped table-bordered" cellspacing="0" width="100%" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">{{$product->qty}}  {{$product->options->type}}</td>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <h5 class="x_title text-center">Amount Calculation</h5>
                    <div class="px-3">
                        ...
                        <table class="table table-striped table-bordered">
                            <tr class="text-right"><th>Total Sales<td>= {{Cart::instance('sales_return')->total()-Cart::instance('sales_return')->tax()}}/=</td></th></tr>
                            ...
                            @else
                                ...
                                <tr class="text-right"><th>Current Due<td>= {{abs($previous_due-$grand_total)  .'/=' ?? ''}}</td></th></tr>
                            @endif
