                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a href="{{route('yearly.bonus.edit',$rate->id)}}" class="btn btn-success"><i class="fa fa-edit" ></i></a></li>
                                                    <li><a href="{{route('yearly.bonus.delete',$rate->id)}}" class="btn btn-danger" id="delete"><i class="fa fa-trash" ></i></a></li>
