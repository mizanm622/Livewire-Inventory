                    ...
                    <div class="row">
                        <div class="collection-form-area">
                            ...
                            <div class="supplier-info-area py-2">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 offset-lg-1 offset-md-1">
                                        <div class="col-lg-2 col-md-2 col-sm-6">
                                            <h4 class="text-center text-dark border form-control">ID:{{ $bonus_list->supplier->id }}</h4>
                                        </div>
                                        <div class="col-lg-3 col-md-2 col-sm-6">
                                            <h4 class="text-wrap text-dark border form-control">Company Name:{{ $bonus_list->supplier->company_name }}</h4>
                                        </div>
                                        <div class="col-lg-3 col-md-2 col-sm-6">
                                            <h4 class="text-wrap text-dark border form-control">Address:{{$bonus_list->supplier->address }}</h4>
                                        </div>
                                        <div class="col-lg-2 col-md-2 col-sm-6">
                                            <h4 class="text-center text-dark border form-control">Mobile:{{$bonus_list->supplier->mobile }}</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
