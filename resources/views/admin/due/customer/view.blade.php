        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="x_panel">
                <div class="back_button mb-2">
                    ...
                    <a href="{{route('customer.due.index')}}" class="btn btn-md btn-primary float-right">Back</a>
                </div>
                <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <h2>Customer Due Information   <small>Customer Due information</small></h2>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 offset-1">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        <tbody>
                                            ...
                                            <tr><th class="text-right">Purpose: <td class="text-wrap">{{$customer->purpose}}</td></th></tr>
