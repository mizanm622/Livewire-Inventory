...
<link rel="stylesheet" href="{{asset('assets/css/dropify.min.css')}}" />
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Add Dokan Expense<small>Add your dokan expense from here</small></h2>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select type="text" id="rent_month" name="rent_month" class="form-control" >
                                            <option value="">Select Option</option>
                                            @foreach($months as $salary_month)
                                                <option value="{{$salary_month}}">{{$salary_month}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="receiving_by">Receive By<span class=""></span>
                                    </label>
                                    <div class="col-md-6 col-sm-6">
