...
<div class="col-md-12 col-sm-12">
    <div class="x_panel">
        <div class="x_title">
                <h2> <a href="{{route('dokan.expense.create')}}" class="btn btn-md btn-primary">+Add Dokan Expense</a> Dokan Expenses List<small>Show dokan expenses list from here</small></h2>
                            ...
                            <tbody>
                                ...
                                @endphp
                                    <tr>
                                        ...
                                        <td>{{$expense->dokan_rent}}</td>
                                        <td>{{$expense->rent_amount}}/-</td>
                                        <td>{{$expense->rent_month}}</td>
