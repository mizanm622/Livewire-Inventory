...
<link rel="stylesheet" href="{{asset('assets/css/dropify.min.css')}}" />
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Update Labour Expense <small>Update your labour expense from here</small></h2>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" id="amount" name="amount" value="{{$labour_expense->amount}}" class="form-control" >
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" id="receive" name="receive" value="{{$labour_expense->receive}}" class="form-control" >
                                    </div>
                                </div>
                                <div class="item form-group">
