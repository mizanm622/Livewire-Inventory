...
<div class="col-md-12 col-sm-12">
    <div class="x_panel">
        <div class="x_title">
                <h2> <a href="{{route('labour.expense.create')}}" class="btn btn-md btn-primary">+Add Labour Expense</a> Labour Expenses List<small>Show labour expenses list from here</small></h2>
