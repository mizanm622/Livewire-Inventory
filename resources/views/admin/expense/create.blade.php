...
<link rel="stylesheet" href="{{asset('assets/css/dropify.min.css')}}" />
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Add Expense<small>Add your expense from here</small></h2>
                ...
                <div class="x_content">
                    ...
                    @endif
                    <form action="{{route('expense.store')}}" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <textarea type="text" name="note" id="note" cols="10" rows="2"  class="form-control"></textarea>
                                    </div>
                                </div>
