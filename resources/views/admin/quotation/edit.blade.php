...
{{-- <div class="row">
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2>Update Customer Due <small>Update your customer due from here</small></h2>
            ...
            <div class="x_content">
                ...
                @endif
                <form action="{{route('customer.due.update')}}" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    @csrf
                            ...
                            <div class="collection-form-area">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"  name="purpose"  value="{{$customer->purpose}}" class="form-control">
                                    </div>
