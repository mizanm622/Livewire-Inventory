...
<link rel="stylesheet" href="{{asset('assets/css/dropify.min.css')}}" />
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Update Expense Category <small>Update your expense category from here</small></h2>
                ...
                <div class="x_content">
                    ...
                    @endif
                    <form action="{{route('expense_category.update')}}" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        @csrf
                            ...
                            <div class="col-12">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <input type="text" id="name" name="name" value="{{$expense_category->name}}" class="form-control">
                                    </div>
