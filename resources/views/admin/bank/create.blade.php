...
<link rel="stylesheet" href="{{asset('assets/css/dropify.min.css')}}" />
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Add Bank <small>Add your bank from here</small></h2>
                ...
                <div class="x_content">
                    ...
                    @endif
                    <form action="{{route('bank.store')}}" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <input type="text" id="title" name="title"  class="form-control" placeholder="Example: DBBL,SIBL,UCB">
                                    </div>
                                </div>
                                <div class="item form-group">
