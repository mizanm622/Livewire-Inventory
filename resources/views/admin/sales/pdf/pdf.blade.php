...
/* use this class to customize page size*/
/* .container-body{
   width: 80%;
   font-size: 12px;
} */
    ...
    <div class="container">
        ...
        <div class="body-area">
            <div class="address-area">
                <h4 class="text-center text-dark">Customer Info</h4>
                <table class="table table-striped table-bordered address-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{{$customer_info->customer->company_name}}</td>
                ...
                <div class="product-list-area">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $sales_qty += $product->product_quantity-$product->product_discount;
                        ...
                        <tr>
                            ...
                            <td class="text-right" colspan="1">Total = {{$sales_qty}} {{ $type}}</td>
