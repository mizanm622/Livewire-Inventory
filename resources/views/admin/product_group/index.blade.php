...
<div class="col-md-12 col-sm-12">
    <div class="x_panel">
        <div class="x_title">
                <h2> <a href="{{route('product_group.create')}}" class="btn btn-md btn-primary">+Add Product Group</a>Product Group List<small>Show product group list from here</small></h2>
